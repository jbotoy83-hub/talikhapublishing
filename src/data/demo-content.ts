...
export const demoPublications: Publication[] = [
  ...
  },
  {
    ...
    recommendedCitation: "Botoy, F. J. M., Barbosa, C. J., Cabatuan, G. K., Lee, H. A., & Onyot, J. (2026). Environmental Literacy and Knowledge Levels of Filipino Learners: A Comprehensive Literature Review. In InQuira (Vol. 2, Number 1, pp. 16–25). Lakbay-Diwa Publishing. https://doi.org/10.5281/zenodo.18207397",
    licenseName: ccBy,
    licenseUrl: ccByUrl,
    copyrightHolder: "The authors",
    featured: true,
  ...
  },
  {
    ...
    recommendedCitation: "Cacho, M. J. V. (2026). Innovation in EPP and Entrepreneurship Education. In Lumera (Vol. 2, Number 6, p. 269). Lakbay-Diwa Publishing. https://doi.org/10.5281/zenodo.21131524",
    licenseName: ccBy,
    licenseUrl: ccByUrl,
